...
**Date:** March 18, 2026  
**Status:** Deterministic synthetic evaluation complete; initial real-trace validation completed on public OPT models  
...
The runtime replay path now supports direct policy comparison on captured decode traces. Two small public models were evaluated as an initial check.
...
**Bottom Line:** Remap plus admission now looks credible on both synthetic and initial real-trace evidence. Replication is improved, but it is not yet the lead result.
